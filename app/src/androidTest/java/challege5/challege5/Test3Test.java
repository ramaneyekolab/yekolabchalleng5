...
public class Test3Test {
    ...
    @Test
    public void mail_Incocorrect(){
        onView(withId(R.id.tv_email)).perform(typeText("ghost@mail.com"),closeSoftKeyboard());
        ...
        onView(withId(android.R.id.message)).inRoot(withDecorView(not(is(monLoginActivityTestRule.getActivity().getWindow().
                getDecorView())))).check(matches(withText("Votre email est incorect !!!")));
    }
